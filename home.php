...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Facebook is developed By us.">
    <meta name="keywords" content="Social Networking site">
...
<p align="center">@<?php echo $_SESSION['Username'];?></p>   <?php //left navigation bar on home ?>
<?php
...
<a href="./u/<?php echo $_SESSION['Username']; ?>&ut=photos"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/1f5fb.png" /> <?php echo lang('my_photos');  // myPhotos ?></p></a> 
<a href="./settings"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/2699.png" /> <?php echo lang('settings');  // settings?></p></a>
<!-- <a href="./settings?tc=language"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/1f998c4.png" /> <?php echo lang('language'); //setlanguage ?></p></a>
 -->
<p class="homeLinks_title"><?php echo lang('my_notepad');  // note?></p>
<a href="./mynotepad/new"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/270f.png" /> <?php echo lang('new_note');  // see all notes?></p></a>
<?php
$msid = $_SESSION['id'];
